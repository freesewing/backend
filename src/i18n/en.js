export default {
  ...
  footerCredits:
    'Made by Joost De Cock & contributors with the financial support of our patrons ❤️ ',
  ...
  questionsJustReply:
    "If you have any questions, just reply to this E-mail. I'm always happy to help out. 🙂",
  signature: 'Love,',

  signupActionText: 'Confirm your E-mail address',
  signupCopy1:
    'Thank you for signing up at <b>freesewing.org</b>.<br><br>Before we get started, you need to confirm your E-mail address. Please click the link below to do that:',
  ...
  emailchangeCopy1:
    'You requested to change the E-mail address linked to your account at <b>freesewing.org</b>.<br><br>Before we do that, you need to confirm your new E-mail address. Please click the link below to do that:',
  ...
  emailchangeWhy:
    'You received this E-mail because you changed the E-mail address linked to account on freesewing.org',

  passwordresetActionText: 'Re-gain access to your account',
  passwordresetCopy1:
    'You forgot your password for your account at <b>freesewing.org</b>.<br><br>Click click the link below to reset your password:',
  ...
  passwordresetWhy:
    'You received this E-mail because you requested to reset your password on freesewing.org',

  goodbyeCopy1:
    "If you'd like to share why you're leaving, you can reply to this message.<br>From our side, we won't bother you again.",
  ...
  goodbyeWhy:
    'You received this E-mail as a final adieu after removing your account on freesewing.org'
}
